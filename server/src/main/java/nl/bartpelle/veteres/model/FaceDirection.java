...
public class FaceDirection {
	...
	public static final FaceDirection NORTH = new FaceDirection(0x2000, 0);
	public static final FaceDirection NORTH_EAST = new FaceDirection(0x2800, 1);
	public static final FaceDirection EAST = new FaceDirection(0x3000, 2);
	public static final FaceDirection SOUTH_EAST = new FaceDirection(0x3800, 3);
	public static final FaceDirection SOUTH = new FaceDirection(0x0000, 4);
	public static final FaceDirection SOUTH_WEST = new FaceDirection(0x800, 5);
	public static final FaceDirection WEST = new FaceDirection(0x1000, 6);
	public static final FaceDirection NORTH_WEST = new FaceDirection(0x1800, 7);
	...
	public static FaceDirection forTargetTile(int xOffset, int yOffset) {
		...
		if (radians < 0)
			radians = 360 + radians;
		return new FaceDirection((int) (theta * 2607.5945876176133) & 0x3fff, fromDegrees((int) radians).bitDirection);
	}
